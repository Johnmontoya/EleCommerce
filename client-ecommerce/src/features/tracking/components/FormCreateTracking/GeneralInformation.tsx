            ...
            <div className="flex flex-row gap-4 space-y-4">
                <div className="w-full">
                    ...
                    <input
                        ...
                        required
                        className="w-full bg-slate-700/50 border border-slate-600 text-emerald-600 font-bold placeholder-slate-500 px-4 py-3 rounded-lg outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all"
