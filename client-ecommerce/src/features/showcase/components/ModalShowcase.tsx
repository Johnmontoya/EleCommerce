...
const ModalShowcase: React.FC<ModalShowcaseProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 font-mono">
            <div className="bg-[#050505] border border-zinc-800 w-full max-w-4xl max-h-[90vh] flex flex-col relative shadow-[0_0_50px_rgba(0,0,0,0.5)]">
                {/* Decorative border corners */}
                <div className="absolute top-0 left-0 w-4 h-4 border-t border-l border-zinc-500 pointer-events-none" />
                <div className="absolute top-0 right-0 w-4 h-4 border-t border-r border-[#00f0ff] pointer-events-none" />
                <div className="absolute bottom-0 left-0 w-4 h-4 border-b border-l border-[#00f0ff] pointer-events-none" />
                <div className="absolute bottom-0 right-0 w-4 h-4 border-b border-r border-[#e4ff00] pointer-events-none" />

                {/* Modal Header */}
                <div className="bg-[#050505] border-b border-zinc-800 p-6 flex items-center justify-between shrink-0 z-10">
                    <h2 className="text-sm font-black text-white uppercase tracking-widest flex items-center gap-2">
                        <span className="text-[#00f0ff]">{'>'}</span> {editingBanner ? "[EDITAR_CONFIG]" : "[NUEVA_CONFIG]"}
                    </h2>
                    <button
                        onClick={onClose}
                    ...
                    <div className="p-6 space-y-8">
                        ...
                        <div>
                            <label className="block text-zinc-500 text-[10px] font-bold uppercase tracking-widest pl-1 border-l-2 border-zinc-800 mb-2 mt-4">
                                [PRODUCTO] <span className="text-[#ff0055]">*</span>
                            </label>
                            <select
                                name="productId"
                            ...
                            >
                                <option value="">[SELECCIONAR_PRODUCTO]</option>
                        ...
                        <div>
                            <label className="block text-zinc-500 text-[10px] font-bold uppercase tracking-widest pl-1 border-l-2 border-zinc-800 mb-4 mt-6">
                                [SECCIONES] <span className="text-[#ff0055]">*</span>
                            </label>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mt-6 border-t border-zinc-800 pt-6 border-dashed">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="1"
                                />
                                <p className="text-[10px] text-zinc-600 uppercase tracking-widest mt-2">1 = PRIMERA_POSICION</p>
                            </div>
                        ...
                        <div className="flex items-center gap-4 p-4 bg-[#e4ff00]/5 border border-[#e4ff00]/30 mt-6 relative group cursor-pointer" onClick={() => !isSubmitting && setFormData({ ...formData, isFeatured: !formData.isFeatured })}>
                            ...
                            <div>
                                <p className="font-bold text-[#e4ff00] flex items-center gap-2 text-xs uppercase tracking-widest mb-1">
                                    [MARCAR_COMO_DESTACADO]
                                </p>
                                <p className="text-[10px] text-zinc-400 uppercase tracking-widest">
                                    [MUESTRA_BADGE_GLOBALE]
                                </p>
                            </div>
                        </div>
                ...
                {/* Modal Footer */}
                <div className="bg-[#050505] border-t border-zinc-800 p-6 flex gap-4 shrink-0 z-10 relative">
                    <button
                        onClick={onClose}
                        type="button"
                        disabled={isSubmitting}
