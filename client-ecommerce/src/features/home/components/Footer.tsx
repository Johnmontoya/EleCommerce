    ...
    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-12">
      ...
      <div className="group">
        <div className="flex items-center space-x-2 mb-6">
          <div className="w-10 h-10 bg-linear-to-r from-cyan-400 to-cyan-500 rounded-lg flex items-center justify-center transform group-hover:rotate-12 transition duration-500">
            <span className="text-xl font-bold">
              <CiShoppingBasket size={32} />
            </span>
          </div>
          <h2 className="text-2xl font-bold uppercase bg-clip-text text-transparent bg-linear-to-r from-cyan-400 to-cyan-400">
            EleCommerce
          </h2>
        </div>
      ...
      <div>
        ...
        <form className="mt-4">
          <div className="relative">
            ...
            <button type="submit" className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-cyan-500 hover:bg-cyan-600 text-white rounded-lg px-4 py-1 transition">
